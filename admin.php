                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong> Login &amp; Register Forms</strong></h1>
                            <div class="description">
                            	<p>
	                            	students create ur account
                            	</p>
                            </div>
                        </div>
                    </div>
	                            ...
	                            <div class="form-bottom">
				                    <form role="form" action="validateadmin.php" method="post" class="login-form" >
				                        ...
				                        <div class="form-group">
				                        	...
				                        	<input type="password" name="form-password" placeholder="Password..." class="form-password form-control" id="form-password" value="">
				                        </div>
				                        <button type="submit" class="btn" onclick="validateSignIn()">Sign in!</button>
				                    </form>
			                    </div>
		                    </div>
