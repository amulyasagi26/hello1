			...
			<div class="input-container">
				<div class="row">
					<span class="req-input valid" >
						...
						<input type="text" data-min-length="8" placeholder="roll no" value="" id="roll" name="roll">
					</span>
				</div>
			
				
				<div class="row submit-row">
					<button type="button" class="btn btn-block submit-form valid" onclick="uvalidate()">Submit</button>
				</div>
				</div>
			</div>
			</form>
