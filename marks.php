...
<head>
	<script >
		function mvalidate()
		{
			...
			{
				alert("enter valide maths marks");

			}
			if((s=="") ||(isNaN(s))||(s<0)||(s>100))
			{
				alert("enter valide science marks");

			}
			if((e=="") ||(isNaN(e))||(e<0)||(e>100))
			{
				alert("enter valide english marks");
    ...
    <title>colorful animated forms - Bootsnipp.com</title>
			...
			<div class="input-container">
				<div class="row">
					<span class="req-input" >
						<span class="input-status" data-toggle="tooltip" data-placement="top" title="Enter maths marks."> </span>
						<input type="text" data-min-length="8" placeholder="Maths" name="maths" id="maths">
					</span>
				</div>
				<div class="row">
					<span class="req-input">
						<span class="input-status" data-toggle="tooltip" data-placement="top" title="Please Input Science marks."> </span>
						<input type="email" placeholder="Science" name="sci" id="sci">
					</span>
				</div>
				<div class="row">
					<span class="req-input">
						<span class="input-status" data-toggle="tooltip" data-placement="top" title="Enter english marks"> </span>
						<input type="tel" placeholder="English" name="eng" id="eng">
					</span>
				</div>
				
				<div class="row submit-row">
					<button type="button" class="btn btn-block submit-form" onclick="mvalidate()">Submit</button>
				</div>
			</div>
			</div>
			</form>
